 ...
 */
class Document extends \AppBundle\Entity\Document implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'description', 'url', 'added', 'folder', 'user'];
        }
    ...
    public function setAdded()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdded', []);

        return parent::setAdded();
    }
